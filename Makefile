...
CC := gcc
CFLAGS_COMMON := -I$(CLASSICS_LIVE_DIR) -I$(CLASSICS_LIVE_LIBRETRO_DIR)/include -Wall -O2 -DCL_TESTS=1
CFLAGS_C89 := $(CFLAGS_COMMON) -std=c89 -pedantic -Wno-implicit-function-declaration
LDFLAGS := -lm
